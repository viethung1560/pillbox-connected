 ...
 */
final class Version20241009153305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medecine_box (id INT AUTO_INCREMENT NOT NULL, drug_id INT NOT NULL, usr_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, expiration_date DATE NOT NULL, conditioning INT DEFAULT NULL, price INT DEFAULT NULL, manufacturer VARCHAR(255) DEFAULT NULL, INDEX IDX_65B347B7AABCA765 (drug_id), INDEX IDX_65B347B7C69D3FB (usr_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE treatment (id INT AUTO_INCREMENT NOT NULL, medecine_box_id INT NOT NULL, frequency INT NOT NULL, last_taking_time DATETIME DEFAULT NULL, compartement INT NOT NULL, UNIQUE INDEX UNIQ_98013C314B001634 (medecine_box_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE treatment ADD CONSTRAINT FK_98013C314B001634 FOREIGN KEY (medecine_box_id) REFERENCES medecine_box (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE treatment DROP FOREIGN KEY FK_98013C314B001634');
