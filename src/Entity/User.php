...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column(length: 10, nullable: true)]
    private ?string $emergency_phone_number = null;

    /**
     * @var Collection<int, MedecineBox>
     */
    #[ORM\OneToMany(targetEntity: MedecineBox::class, mappedBy: 'usr')]
    ...
    public function setEmergencyPhoneNumber(?string $emergency_phone_number): static
    {
    ...
    public function removeMedecineBox(MedecineBox $medecineBox): static
    {
        if ($this->medecine_boxes->removeElement($medecineBox)) {
            ...
            if ($medecineBox->getUsr() === $this) {
                $medecineBox->setUsr(null);
            }
        }
